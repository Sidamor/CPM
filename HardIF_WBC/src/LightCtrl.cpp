...
void CLightCtrl::AllLightOFF()
{
	...
	BackLightSet(INTERFACE_RS485_B1, LIGHT_OFF);
	BackLightSet(INTERFACE_RS485_A1, LIGHT_OFF);
	BackLightSet(INTERFACE_RS485_B2, LIGHT_OFF);
	BackLightSet(INTERFACE_RS485_A2, LIGHT_OFF);
	BackLightSet(INTERFACE_RS485_B0, LIGHT_OFF);
	BackLightSet(INTERFACE_RS485_A0, LIGHT_OFF);
	//-----------------模拟量区灯状态------------------
...
void CLightCtrl::AllLightON()
{
	...
	BackLightSet(INTERFACE_RS485_B1, LIGHT_ON);
	BackLightSet(INTERFACE_RS485_A1, LIGHT_ON);
	BackLightSet(INTERFACE_RS485_B2, LIGHT_ON);
	BackLightSet(INTERFACE_RS485_A2, LIGHT_ON);
	BackLightSet(INTERFACE_RS485_B0, LIGHT_ON);
	BackLightSet(INTERFACE_RS485_A0, LIGHT_ON);
	//-----------------模拟量区灯状态------------------
